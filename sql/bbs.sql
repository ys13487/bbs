...
CREATE TABLE `article` (
  ...
  `userid` int(5) DEFAULT NULL COMMENT '外键->表user',
  `title` varchar(800) DEFAULT NULL COMMENT '文章标题\r\n文章标题',
  `author` varchar(800) DEFAULT NULL COMMENT '文章作者',
...
CREATE TABLE `permission` (
  ...
  `uri` varchar(255) DEFAULT NULL COMMENT '权限对应的uri',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `reply` (
  `id` int(5) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `article_id` int(5) DEFAULT NULL COMMENT '外键->表article',
  `replyer` varchar(255) DEFAULT NULL COMMENT '评论人',
  `date` datetime DEFAULT NULL COMMENT '评论时间',
  `reply` varchar(800) DEFAULT NULL COMMENT '评论内容',
  PRIMARY KEY (`id`) USING BTREE,
  KEY `y` (`article_id`) USING BTREE,
  KEY `a` (`replyer`) USING BTREE,
  CONSTRAINT `a` FOREIGN KEY (`replyer`) REFERENCES `user` (`nickname`) ON DELETE CASCADE,
  CONSTRAINT `y` FOREIGN KEY (`article_id`) REFERENCES `article` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=1022 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;

-- ----------------------------
-- Records of reply
-- ----------------------------
INSERT INTO `reply` VALUES ('1002', '1007', '是老杨啊', '2019-05-18 16:14:42', '666');
INSERT INTO `reply` VALUES ('1003', '1007', '是老杨啊', '2019-05-18 16:15:11', '说的好');
INSERT INTO `reply` VALUES ('1004', '1007', '是老杨啊', '2019-05-18 16:15:41', '哎哟');
INSERT INTO `reply` VALUES ('1005', '1007', '臭弟弟', '2019-05-18 16:13:01', '是多久才能深刻的接口啊谁对谁错但是');
INSERT INTO `reply` VALUES ('1006', '1007', '是老杨啊', '2019-05-18 16:11:26', '咳咳');
INSERT INTO `reply` VALUES ('1020', '1013', 'ys13487', '2019-08-19 07:28:33', 'test1');
INSERT INTO `reply` VALUES ('1021', '1007', 'ys13487', '2019-08-19 07:29:27', '6666');
...
CREATE TABLE `role` (
  `id` int(5) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `role` varchar(10) DEFAULT NULL COMMENT '角色名称',
  `level` int(5) DEFAULT NULL COMMENT '角色等级超级管理员（3），管理员（2），普通会员（1）',
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('1005', '是老杨啊', '13260906172', '2ca9e533b499a7e4453b512c9b2e06a8');
INSERT INTO `user` VALUES ('1006', '臭弟弟', '17856690931', '2ca9e533b499a7e4453b512c9b2e06a8');
INSERT INTO `user` VALUES ('1007', '一个被封了的账号', '13260906666', '2ca9e533b499a7e4453b512c9b2e06a8');
INSERT INTO `user` VALUES ('1008', '丑徒儿', '13260907777', '2ca9e533b499a7e4453b512c9b2e06a8');
INSERT INTO `user` VALUES ('1012', 'test', '13260906171', '2ca9e533b499a7e4453b512c9b2e06a8');
INSERT INTO `user` VALUES ('1013', 'ys13487', '15958596961', 'e10adc3949ba59abbe56e057f20f883e');
INSERT INTO `user` VALUES ('1014', 'test01', '15958596962', 'e10adc3949ba59abbe56e057f20f883e');
...
INSERT INTO `user_role` VALUES ('1013', '1');
INSERT INTO `user_role` VALUES ('1014', '3');
